...
export function UpgradeCta({ compact }: Props) {
  ...
  if (compact) {
    if (plan === "pro") {
      return (
        <Link
          href="/settings"
          className="inline-flex items-center gap-1 rounded-full bg-primary/15 border border-primary/25 px-2.5 py-1 text-[11px] font-semibold text-primary hover:bg-primary/25 transition-colors active:scale-[0.97]"
        >
    ...
    return (
      <Link
        ...
        className={cn(
          ...
          "hover:bg-primary/20 hover:border-primary/55 transition-colors active:scale-[0.97]",
        )}
      >
  ...
  if (plan === "pro") {
    return (
      <Link
        href="/settings"
        className="mx-3 mb-2 flex items-center gap-2.5 rounded-xl bg-primary/10 border border-primary/20 px-3 py-2.5 hover:bg-primary/15 transition-colors active:scale-[0.98] group"
      >
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        "hover:border-primary/45 hover:from-primary/14 transition-all active:scale-[0.98] group",
      )}
    >
